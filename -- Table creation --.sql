...
-- Units table
CREATE TABLE units (
    Unit_id SERIAL PRIMARY KEY, Unit_name VARCHAR(100) NOT NULL, Faction_id INT NOT NULL REFERENCES factions (Faction_id), Unit_type VARCHAR(50), Nb_fig INT NOT NULL, M VARCHAR(10) NOT NULL, BS VARCHAR(10) NOT NULL, WS VARCHAR(10) NOT NULL, S INT NOT NULL, T INT NOT NULL, W INT NOT NULL, A INT NOT NULL, I INT NOT NULL, Ld VARCHAR(10) NOT NULL, OC INT NOT NULL, Sv VARCHAR(10) NOT NULL, Invul_sv VARCHAR(10), Aptitudes VARCHAR(100) NOT NULL, Special_rules VARCHAR(100) NOT NULL, U_Pts INT);
...
-- Units Rules table
CREATE TABLE units_rules_aptitudes (
    Unit_id INT NOT NULL REFERENCES units (Unit_id), Rule_id INT NOT NULL REFERENCES special_rules (Rule_id), Aptitude_id INT NOT NULL REFERENCES units_aptitudes (Aptitude_id));
-- Units Psy table
